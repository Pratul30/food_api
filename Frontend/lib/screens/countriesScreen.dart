          ...
          child: Container(
                ...
                child: Center(
                  child: SearchInputWidget(
                    ...
                    searchCtrl: searCtrl,
                    placeholder: 'currency, country or dial-code',
                    clear: (){
                      setState(() {
                        typeValue = "";
                        searCtrl.clear();
            ...
            ? ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return Padding(
                  ...
                  child: InkWell(
                    child: listCountries(_countries.countrieFilters[index]),
                    onTap: (){
                      var data;
                      if(widget.value == 'phone'){
                        data = {
                          'dialCode': _countries.countrieFilters[index]['phone_code'],
                          'country': _countries.countrieFilters[index]['country_code'],
                        };
                      } else {
                          data = {
                            'currency': _countries.countrieFilters[index]['currency_code'],
                            'country': _countries.countrieFilters[index]['country_name'],
                        };
                      }
          ...
          return Padding(
            ...
            child: InkWell(
              ...
              onTap: (){
                ...
                if(widget.value == 'phone'){
                  data = {
                    'dialCode': _countries.countries[index]['phone_code'],
                    'country': _countries.countries[index]['country_code'],
                  };
                } else {
                    data = {
                      'currency': _countries.countries[index]['currency_code'],
                      'country': _countries.countries[index]['country_name'],
                  };
                }
                Navigator.pop(context, data);
              },
