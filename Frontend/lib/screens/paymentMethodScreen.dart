...
class _PaymentMethodScreenState extends State<PaymentMethodScreen> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<PaymentVM>(context, listen: false)
          .paymentListByCountry(widget.currency);
    });
    super.initState();
  }
                ...
                ? GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Padding(
                        ...
                        child: InkWell(
                          child:
                              listPaymentMethods(_payment.paymentMethod[index]),
                          onTap: () {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(data['full_name'].toString().toUpperCase(),
                  style: TextStyle(
                      fontSize: 18,
                      color: Colors.purple,
                      fontWeight: FontWeight.bold)),
